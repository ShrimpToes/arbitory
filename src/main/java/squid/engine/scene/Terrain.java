...
public class Terrain {
    ...
    private final GamePiece<HeightMap>[] gamePieces;
    ...
    public Terrain(int blocksPerRow, float scale, float minY, float maxY, String heightMapFile, String textureFile, int textInc) throws Exception {
        ...
        for (int row = 0; row < blocksPerRow; row++) {
            for (int col = 0; col < blocksPerRow; col++) {
                ...
                GamePiece<HeightMap> terrainBlock = new GamePiece<>(heightMap);
    ...
    public float getHeight(Vector3f position) {
        ...
        boolean found = false;
        GamePiece<HeightMap> terrainBlock = null;
    ...
    protected Vector3f[] getTriangle(Vector3f position, Box2D boundingBox, GamePiece<HeightMap> terrainBlock) {
    ...
    private Box2D getBoundingBox(GamePiece<HeightMap> terrainBlock) {
